    ...
    return (
        <div className='' >
            ...
            >
                ...
                <h1 className='text-5xl uppercase text-white' > <span className='font-bold' >contact </span> Us</h1>
            ...
            <div className='mx-auto my-10 2xl:w-[70%] lg:w-[85%] grid grid-cols-2 gap-10 '>
