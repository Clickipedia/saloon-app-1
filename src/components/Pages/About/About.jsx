        ...
        <div className='mb-20'>
            ...
            >
                <div className='all-bg-filter'>
                    ...
                    <h1 className='md:text-5xl text-2xl text-white' > <span className='font-bold' >WE ARE</span> PASSIONATE TEAM</h1>
                </div>

            </div>
            <div className=' bg-[#1e1e45] 2xl:px-[20rem] lg:px-20 px-5 py-20 space-y-10 text-white'>
