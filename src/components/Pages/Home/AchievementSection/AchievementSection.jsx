...
const AchievementSection = () => {
    ...
    return (
        ...
        <div className='bg-cover md:bg-bottom bg-white bg-no-repeat md:ps-40 p-2 text-black flex items-center h-[55vh]'
        ...
        >
            <div className='md:w-[45%] space-y-8'>
                <div className='md:h-[110px] md:w-[210px] md:border-b-2 border-[#d8a62a]'>
                ...
                <div className='flex justify-between gap-3'>
                    ...
                    <div>
                        ...
                        <h1 className='font-semibold 2xl:text-lg text-xs' >Happy Customers</h1>
                    </div>
                    ...
                    <div>
                        ...
                        <h1 className='font-semibold 2xl:text-lg text-xs' >Passionate Makeup Artist</h1>
                    </div>
                    ...
                    <div>
                        ...
                        <h1 className='font-semibold 2xl:text-lg text-xs' >Clinic Arround The World</h1>
                    </div>
