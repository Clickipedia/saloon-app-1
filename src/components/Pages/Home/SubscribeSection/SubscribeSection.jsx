...
const SubscribeSection = () => {
    return (
        <div className='bg-[#737373] py-[6rem]'>
            <div className='grid md:grid-cols-2 grid-cols-1 items-center w-[80%] mx-auto gap-5'>
                <div className='space-y-5'>
                    <h1 className='text-2xl font-bold' >SUBSCRIBE OUR NEWSLETTER</h1>
                    <p>Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam  nonummy nibh euismod tincidunt ut laoreet</p>
                </div>
                <div className='text-right relative'>
                    <input className='subs-input px-8 py-4 md:w-[30rem] w-full bg-[#969696] pe-20' type="text" placeholder='Enter your e-mail address' />
